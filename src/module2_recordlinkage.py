...
def record_linkage_pipeline_full_address(left_df, right_df, filename):
    ...
    compare_cl = Compare()
    columns_to_compare = ['name', 'full_address']
    for column in columns_to_compare:
        compare_cl.string(column, column, method='jarowinkler')
